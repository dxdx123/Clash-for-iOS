...
final class MGAppDelegate: NSObject, UIApplicationDelegate, UNUserNotificationCenterDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey : Any]? = nil) -> Bool {
        if !UserDefaults.standard.bool(forKey: MGConstant.isAppHasLaunched) {
            ...
            UserDefaults.shared.set(true, forKey: MGConstant.Xray.sniffingEnable)
            UserDefaults.shared.set(true, forKey: MGConstant.Xray.sniffingDestOverrideHTTP)
            UserDefaults.shared.set(true, forKey: MGConstant.Xray.sniffingDestOverrideTLS)
            UserDefaults.shared.set(false, forKey: MGConstant.Xray.sniffingDestOverrideQUIC)
            UserDefaults.shared.set(false, forKey: MGConstant.Xray.sniffingDestOverrideFAKEDNS)
